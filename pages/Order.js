      ...
      <View style={{ flex: 1}}>
        {
          this.state.showME ?
            ...
            <View>
              ...
              <Text style={{ fontSize: 30, textAlign: 'left', paddingBottom: 20 }}>เมนูอาหารที่คุณได้ทำการสั่ง</Text>

              


<Text style={{ fontSize: 25, textAlign: 'left', paddingBottom: 20 }}>ร้านป้าละม่อม</Text>
              <Image source={lamom} style={{ width: 420, height: 300, justifyContent: 'center' }} />
              <Text style={{ fontSize: 25, textAlign: 'left', paddingBottom: 20 }}>ข้าวผัดกุ้ง  :  40 บาท  </Text>
              <Mybutton 
             title ="      ชำระเงิน      "
            />
