    ...
    return (
      <View style={{ flex: 1 }}>
        ...
        <AwesomeButton
          ...
          <Text style={{ color: 'white', paddingBottom: 10 }}>                                                ร้านโปรดของคุณ                                               </Text>
        </AwesomeButton>

        <AwesomeButton
          onPress={this.changeName}>
          <Text style={{ color: 'white', paddingBottom: 10 }}>                                                    การชำระเงิน                                                   </Text>
        </AwesomeButton>

        <AwesomeButton
          onPress={this.changeName}>
          <Text style={{ color: 'white', paddingBottom: 10 }}>                                                      การจัดส่ง                                                      </Text>
        </AwesomeButton>
        ...
        <AwesomeButton
          onPress={this.changeName}>
          <Text style={{ color: 'white', paddingBottom: 10 }}>                                                      การตั้งค่า                                                      </Text>
        </AwesomeButton>
